...
function buildSystemPrompt(opts) {
  ...
  const lines = [
    ...
    "FORMAT — reply in PLAIN TEXT only (this is sent over WhatsApp). Do NOT use Markdown or HTML: no **bold**, no _italics_, no headings (#), no backticks, no [text](url) links, and no <a>/<...> tags. Write any link as a plain URL, e.g. https://wa.me/77770739990 . Short line breaks and a few emoji are fine.",
    "",
