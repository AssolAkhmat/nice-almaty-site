...
function buildSystemPrompt(opts) {
  ...
  if (onWhatsApp) {
    lines.push(
      "",
      "HUMAN HANDOFF (WhatsApp / Wazzup):",
      "- Call a human manager when you cannot decide alone: deposit/discount exceptions, special family cases, exact address, finalize payment, complaints, anything outside FAQ/house files.",
      "- Then politely tell the customer a manager will continue in this same chat, AND append on its OWN last line exactly: [МЕНЕДЖЕР]",
      "- Do not write [МЕНЕДЖЕР] for ordinary answered questions (prices, free places, routes, FAQ)."
    );
  }
