...
//   2. Phone outbound (Wazzup isEcho=true — handset/iframe, NOT Admin API)
//      or Wazzup UI (sentFromApp) — noteManagerActivity
...
//
// Admin API echoes (crmMessageId nice-bot-* / outbound without isEcho) never mute.
...
// After Phone/manager takes the chat (or bot handoff), stay silent for 1 hour.
const DEFAULT_MUTE_MS = Number(process.env.WA_MANAGER_MUTE_MS || 60 * 60 * 1000);
// Customer message → wait this long for Phone before the bot answers (see lib/pending-reply.js).
